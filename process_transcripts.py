...
#  File Name - Process_transcripts.py
#
#  Authors - Chandrashekar B N , Srinivas Chakravarthy
#
##################################################################################
#
#  This file processes the preprocessed transcript data and gets the action items
#  and the summary from the data
#
#
###################################################################################
import os
...
# Dataset files if training has to be performed
...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--actions", required=False, default="yes", help="Get only actions statements")
    parser.add_argument("-m", "--summary", required=False, default="yes", help="Get only summary statements")
    parser.add_argument("-n", "--others", required=False, default="yes", help="Get statements other than actions and summary statements")
